const translations = {
    en: {
        ...
        pricing_basic: "Basic Package",
        pricing_basic_desc: "Perfect for small projects and startups",
        pricing_basic_price: "$150",
        pricing_starting: "Starting from",
        pricing_feature_1: "Simple mobile app or website",
        pricing_feature_2: "Modern responsive design",
        pricing_feature_3: "Basic features",
        pricing_feature_4: "1 week delivery",
        pricing_feature_5: "1 month free support",
        pricing_cta: "Get Started",
        pricing_popular: "Most Popular",
        pricing_pro: "Professional Package",
        pricing_pro_desc: "Best choice for growing businesses",
        pricing_pro_price: "$400",
        pricing_pro_feature_1: "Advanced app or website",
        pricing_pro_feature_2: "Premium UI/UX design",
        pricing_pro_feature_3: "Firebase integration",
        pricing_pro_feature_4: "Admin dashboard",
        pricing_pro_feature_5: "2-3 weeks delivery",
        pricing_pro_feature_6: "3 months free support",
        pricing_enterprise: "Enterprise Package",
        pricing_enterprise_desc: "Complete solutions for large projects",
        pricing_enterprise_price: "$800+",
        pricing_custom: "Custom Quote",
        pricing_ent_feature_1: "Complex multi-platform app",
        pricing_ent_feature_2: "Custom design & branding",
        pricing_ent_feature_3: "Full backend & APIs",
        pricing_ent_feature_4: "Payment integration",
        pricing_ent_feature_5: "Analytics & reporting",
        pricing_ent_feature_6: "6 months free support",
        faq_title: "Frequently Asked Questions",
        faq_q1: "How long does it take to develop a mobile app?",
        faq_a1: "Development time depends on the project complexity. Simple apps take 1-2 weeks, medium projects 2-4 weeks, and complex apps with multiple features may take 1-2 months.",
        faq_q2: "What payment methods do you accept?",
        faq_a2: "I accept various payment methods including bank transfer, PayPal, Western Union, and local payment methods in Iraq. Payment is typically 50% upfront and 50% on delivery.",
        faq_q3: "Do you provide post-delivery support?",
        faq_a3: "Yes! All packages include free support after delivery. Basic packages get 1 month, Professional get 3 months, and Enterprise get 6 months of free support for bug fixes and minor updates.",
        faq_q4: "Can you work on both Android and iOS?",
        faq_a4: "Yes! I use Flutter which allows me to build apps for both Android and iOS from a single codebase. This saves time and ensures consistent experience across platforms.",
        faq_q5: "Do you provide the source code?",
        faq_a5: "Yes, you receive full ownership of the source code upon project completion and final payment. This includes all design files, code, and documentation.",
        chat_title: "💬 Quick Help",
        chat_welcome: "Hello! 👋 How can I help you today? Choose an option below or type your message.",
    ...
    ar: {
        ...
        pricing: "الأسعار",
        pricing_title: "أسعار الخدمات",
        pricing_basic: "الباقة الأساسية",
        pricing_basic_desc: "مثالية للمشاريع الصغيرة والشركات الناشئة",
        pricing_basic_price: "$150",
        pricing_starting: "تبدأ من",
        pricing_feature_1: "تطبيق أو موقع بسيط",
        pricing_feature_2: "تصميم حديث متجاوب",
        pricing_feature_3: "ميزات أساسية",
        pricing_feature_4: "تسليم خلال أسبوع",
        pricing_feature_5: "دعم مجاني شهر واحد",
        pricing_cta: "ابدأ الآن",
        pricing_popular: "الأكثر طلباً",
        pricing_pro: "الباقة الاحترافية",
        pricing_pro_desc: "الخيار الأفضل للأعمال النامية",
        pricing_pro_price: "$400",
        pricing_pro_feature_1: "تطبيق أو موقع متقدم",
        pricing_pro_feature_2: "تصميم UI/UX مميز",
        pricing_pro_feature_3: "تكامل Firebase",
        pricing_pro_feature_4: "لوحة تحكم إدارية",
        pricing_pro_feature_5: "تسليم 2-3 أسابيع",
        pricing_pro_feature_6: "دعم مجاني 3 أشهر",
        pricing_enterprise: "الباقة المتكاملة",
        pricing_enterprise_desc: "حلول شاملة للمشاريع الكبيرة",
        pricing_enterprise_price: "+$800",
        pricing_custom: "سعر مخصص",
        pricing_ent_feature_1: "تطبيق معقد متعدد المنصات",
        pricing_ent_feature_2: "تصميم وهوية بصرية مخصصة",
        pricing_ent_feature_3: "باك اند كامل و APIs",
        pricing_ent_feature_4: "تكامل الدفع الإلكتروني",
        pricing_ent_feature_5: "تحليلات وتقارير",
        pricing_ent_feature_6: "دعم مجاني 6 أشهر",
        faq_title: "الأسئلة الشائعة",
        faq_q1: "كم يستغرق تطوير تطبيق موبايل؟",
        faq_a1: "يعتمد الوقت على تعقيد المشروع. التطبيقات البسيطة تستغرق 1-2 أسبوع، المشاريع المتوسطة 2-4 أسابيع، والتطبيقات المعقدة قد تستغرق 1-2 شهر.",
        faq_q2: "ما هي طرق الدفع المتاحة؟",
        faq_a2: "أقبل طرق دفع متعددة تشمل التحويل البنكي، PayPal، Western Union، وطرق الدفع المحلية في العراق. عادةً الدفع 50% مقدماً و50% عند التسليم.",
        faq_q3: "هل توفر دعم بعد التسليم؟",
        faq_a3: "نعم! جميع الباقات تشمل دعم مجاني بعد التسليم. الباقة الأساسية شهر واحد، الاحترافية 3 أشهر، والمتكاملة 6 أشهر لإصلاح الأخطاء والتحديثات البسيطة.",
        faq_q4: "هل تعمل على أندرويد و iOS؟",
        faq_a4: "نعم! أستخدم Flutter الذي يسمح لي ببناء تطبيقات لأندرويد و iOS من كود واحد. هذا يوفر الوقت ويضمن تجربة متسقة عبر المنصات.",
        faq_q5: "هل توفر الكود المصدري؟",
        faq_a5: "نعم، تحصل على ملكية كاملة للكود المصدري عند اكتمال المشروع والدفع النهائي. يشمل ذلك جميع ملفات التصميم والكود والوثائق.",
        chat_title: "💬 مساعدة سريعة",
        chat_welcome: "مرحباً! 👋 كيف أقدر أساعدك اليوم؟ اختر خيار أو اكتب رسالتك.",
